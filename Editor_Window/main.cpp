...
#include "..\\EngineStudy_Window\jwLoadResources.h"
#include "..\\EngineStudy_Window\jwToolScene.h"
...
{
    jw::Scene* activeScene = jw::SceneManager::GetActiveScene();
